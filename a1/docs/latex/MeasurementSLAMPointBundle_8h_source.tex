...
\DoxyCodeLine{00057\ \ \ \ \ \textcolor{comment}{//\ TODO:\ Lab\ 8}}
\DoxyCodeLine{00058\ }
\DoxyCodeLine{00059\ \ \ \ \ \textcolor{comment}{//\ Pixel\ coordinates}}
\DoxyCodeLine{00060\ \ \ \ \ Eigen::Vector2<Scalar>\ rQOi\ =\ camera\_.vectorToPixel(rPCc);}
\DoxyCodeLine{00061\ \ \ \ \ \textcolor{comment}{//\ TODO:\ Lab\ 8}}
\DoxyCodeLine{00062\ \ \ \ \ \textcolor{keywordflow}{return}\ rQOi;}
\DoxyCodeLine{00063\ \}}
\DoxyCodeLine{00064\ }
\DoxyCodeLine{00065\ \textcolor{comment}{//\ Image\ feature\ locations\ for\ a\ bundle\ of\ landmarks}}
\DoxyCodeLine{00066\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ Scalar>}
\DoxyCodeLine{00067\ Eigen::VectorX<Scalar>\ MeasurementPointBundle::predictFeatureBundle(\textcolor{keyword}{const}\ Eigen::VectorX<Scalar>\ \&\ x,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{classSystemSLAM}{SystemSLAM}}\ \&\ system,\ \textcolor{keyword}{const}\ std::vector<std::size\_t>\ \&\ idxLandmarks)\textcolor{keyword}{\ const}}
\DoxyCodeLine{00068\ \textcolor{keyword}{}\{}
\DoxyCodeLine{00069\ \ \ \ \ assert(x.size()\ ==\ system.\mbox{\hyperlink{classSystemEstimator_a3459a820d965e53e8984ffdf800ef790}{density}}.\mbox{\hyperlink{classGaussianInfo_ac726ca2019576d3297070b77607acb83}{dim}}());}
\DoxyCodeLine{00070\ }
\DoxyCodeLine{00071\ \ \ \ \ \textcolor{keyword}{const}\ std::size\_t\ \&\ nL\ =\ idxLandmarks.size();}
\DoxyCodeLine{00072\ \ \ \ \ Eigen::VectorX<Scalar>\ h(2*nL);}
\DoxyCodeLine{00073\ \ \ \ \ \textcolor{keywordflow}{for}\ (std::size\_t\ i\ =\ 0;\ i\ <\ nL;\ ++i)}
\DoxyCodeLine{00074\ \ \ \ \ \{}
\DoxyCodeLine{00075\ \ \ \ \ \ \ \ \ Eigen::Vector2<Scalar>\ rQOi\ =\ predictFeature(x,\ system,\ idxLandmarks[i]);}
\DoxyCodeLine{00076\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Set\ pair\ of\ elements\ of\ h}}
\DoxyCodeLine{00077\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ TODO:\ Lab\ 9}}
\DoxyCodeLine{00078\ \ \ \ \ \ \ \ \ h.template\ segment<2>(2*i)\ =\ rQOi;}
\DoxyCodeLine{00079\ \ \ \ \ \}}
